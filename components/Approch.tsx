    ...
    <section className="w-full py-20 ">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        <Card
          ...
          description ="we'll collaborate to map out your website's goals, target audience, and key functionalities. we'll discuss thing like Architecture of the website, content requirements, Data flow model, Colors palette etc." 
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card title="Development and Testing" icon={<AceternityIcon order='phase 2' />}
         description ="Once we agree on the plan, I cue my lofi playlist and dive into coding. From initial sketches to polished code, I keep you updated every step of the way and perform unit testing every day."
